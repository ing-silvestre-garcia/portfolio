...
import profilePic from '../../public/images/profile/silver.jpg'
    ...
    return (
        ...
        <main className='flex w.full flex-col items-center justify-center dark:text-light'>
            <Layout className='pt-16'>
                <AnimatedText text="Passion for Innovate!" className='mb-16 lg:!text-7xl sm:!text-6xl xs:text-4xl sm:mb-8' />
