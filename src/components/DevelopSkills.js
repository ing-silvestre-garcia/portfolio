...
const DevelopSkills = () => {
    return (
        <>
            <h2 className='font-bold text-8xl mt-64 w-full text-center md:text-6xl md:mt-32'>Develop Skills</h2>
            ...
            sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
                ...
                <Skill name="SSH" x="32vw" y="5vw" />
                <Skill name="NestJs" x="-25vw" y="18vw" />
                <Skill name="Firebase" x="-5vw" y="-10vw" />
                <Skill name="TDD" x="0vw" y="-15vw" />
                <Skill name="PHP" x="18vw" y="18vw" />
                <Skill name="Go" x="8vw" y="18vw" />
                <Skill name="Zend" x="18vw" y="-18vw" />
                <Skill name="MongoDB" x="-18vw" y="-8vw" />
                <Skill name="MySQL" x="-18vw" y="-20vw" />
            </div>
        </>
    )
}
